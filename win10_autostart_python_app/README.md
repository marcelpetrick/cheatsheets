# One way to configure auto-start for Python3-scripts for Windows 10
...
When the system reboots and logs in, thne after some seconds (not immediately!) a terminal opens, where you can follow along the output (create venv, install requirements, start script ..).
